...
let ProductVariantRepository = class ProductVariantRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(product_variant_entity_1.ProductVariant, dataSource.createEntityManager());
    }
};
